...
import com.lancamento.api.service.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<Pessoa> buscarPeloCodigo(@PathVariable Long codigo) {
		return pessoaRepository.exists(codigo) ? ResponseEntity.ok().body(pessoaRepository.findOne(codigo)) : ResponseEntity.notFound().build();
	}
